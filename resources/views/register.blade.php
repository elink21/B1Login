...
<body>
    <div class="registerForm">
        <div class="demo-section k-content">
            ...
            <form id="exampleform" method="POST" action="registerUser/">
            </form>
        </div>
                        ...
                        items: [{
                            ...
                            },
                            {
                                ...
                                editor: function(container, options) {
                                    container.append($(
                                        "<input type='password' class='k-textbox k-valid' id='Password' name='password' title='Password' required='required' autocomplete='off' aria-labelledby='Password-form-label' data-bind='value:Password' aria-describedby='Password-form-hint'>"
                                    ));
                                }
                            },
                            {
                                ...
                                editor: function(container,options){
                                    container.append($(
                                        "<input type='hidden' class='k-textbox k-valid' id='Password' name='_token' readonly required='required' autocomplete='off' >"
                                    ))
                                }
                            }
    ...
    <div class="illustration">
        <svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
            width="744.84799" height="747.07702" viewBox="0 0 744.84799 747.07702">
            ...
            <path
                ...
                transform="translate(-227.576 -76.46149)" fill="#f9a826" />
