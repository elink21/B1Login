...
@section('page')
    ...
    <div id="passwordRecoveryLayout">
        <div id="emailInputField">
            <h1>Don´t worry</h1>
            <h2>Just type your email bellow and you'll have your password back in no time!</h2> <br>
        ...
        <div id="illustration">
            <svg id="a51d4639-2054-454d-a26d-938e218c2a6d" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                width="890" height="729.78732" viewBox="0 0 890 729.78732">
                <path
                    ...
                    transform="translate(-155 -85.10634)" fill="#2f2e41" />
                <path
                    ...
                    transform="translate(-155 -85.10634)" fill="#e6e6e6" />
                <path
                    ...
                    transform="translate(-155 -85.10634)" fill="#e6e6e6" />
                <circle cx="86.22975" cy="648.0507" r="80" fill="#f9a826" />
                <path
                ...
                <path
                    ...
                    transform="translate(-155 -85.10634)" fill="#ffb8b8" />
                <path
                ...
                <path
                    ...
                    transform="translate(-155 -85.10634)" fill="#2f2e41" />
                <path d="M362.8914,764.87846s20.27835,22.71179,24.334,35.68994" transform="translate(-155 -85.10634)"
                ...
                <path
                    ...
                    transform="translate(-155 -85.10634)" fill="#f9a826" />
                <path d="M455.36073,628.60789,427.3766,605.49058l9.32806-53.94043,38.12333,40.5567Z"
                    transform="translate(-155 -85.10634)" fill="#f9a826" />
                <path id="bc7f4772-a479-43ba-84b6-0038831d0625" data-name="b82a9922-ead1-40af-af3b-f133b244cde7"
                    ...
                    transform="translate(-155 -85.10634)" fill="#3f3d56" />
                <path id="e7549b14-e146-4c1f-8b4f-7638ef62aaf0" data-name="b2a7827b-2d2c-407d-93be-35e4c67116bc"
                    ...
                    transform="translate(-155 -85.10634)" fill="#fff" />
                <circle id="f4a12a6a-3235-4aa9-87a4-fdfa38e5097e" data-name="e6b07811-3d0f-4972-ba4c-46b0c6566e33"
                    cx="583.65849" cy="651.74596" r="26" fill="#e6e6e6" />
                <path
                ...
                <path
                    ...
                    transform="translate(-155 -85.10634)" fill="#2f2e41" />
                <circle cx="414.12375" cy="497.99856" r="29.28259"
                    transform="translate(-376.48586 537.39714) rotate(-61.33682)" fill="#ffb6b6" />
                <path
                ...
                <path
                    ...
                    transform="translate(-155 -85.10634)" fill="#2f2e41" />
                <path d="M1044,814.89366H156a1,1,0,0,1,0-2h888a1,1,0,0,1,0,2Z" transform="translate(-155 -85.10634)"
                    fill="#cacaca" />
            </svg>
        </div>
    </div>
